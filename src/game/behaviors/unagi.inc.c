...
void bhv_unagi_init(void) {
    if (o->oBehParams2ndByte != 1) {
        // _EDIT_ remove reference to 'jrb_seg7_trajectory_unagi_1'
        o->oPathedStartWaypoint = 0; // segmented_to_virtual(jrb_seg7_trajectory_unagi_1);
        ...
        // _EDIT_ remove reference to 'jrb_seg7_trajectory_unagi_2'
        o->oPathedStartWaypoint = 0; // segmented_to_virtual(jrb_seg7_trajectory_unagi_2);
        o->oAction = 3;
        o->oAnimState = 1;
