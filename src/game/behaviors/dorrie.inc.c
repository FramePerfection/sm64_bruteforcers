...
void dorrie_act_move(void) {
    ...
    if (o->oDorrieForwardDistToMario < 320.0f && o->oDorrieGroundPounded) {
        ...
        // _EDIT_ remove reference to 'dorrie_seg6_collision_0600FBB8'
        o->collisionData = 0; // segmented_to_virtual(dorrie_seg6_collision_0600FBB8);
...
void dorrie_act_raise_head(void) {
    // _EDIT_ remove reference to 'dorrie_seg6_collision_0600F644' 
    o->collisionData = 0; // segmented_to_virtual(dorrie_seg6_collision_0600F644);
