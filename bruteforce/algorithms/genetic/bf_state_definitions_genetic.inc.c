...
BF_CONTROL_STATE(u32, merge_interval, "The rate at which processes should share their best runs with each other, and merge them down into one set of survivors.")
